...
public class StringAppl {
    public static void main(String[] args) {
        ...
        System.out.println("-------------");
        String str1 = "Hello";
        char[] str2 = {32,'w','o','r','l','d'};//array of char, 32 - ASCII код пробела
        String str3 = new String(str2);
        String str4 = str1 + str3;
        System.out.println(str4);
        System.out.println("-------------");
        str = str1.concat(str3);//объединение строк
        System.out.println(str);
        //length
        int l= str.length();
        ...
        System.out.println(check);// expert true
        System.out.println("--------------");
