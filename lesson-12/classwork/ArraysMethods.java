...
public class ArraysMethods {
    ...
    //Bubble sort
    // comparing two element of array: array [i] ? array [i + 1]
    ...
    //binary search
    //метод будет возвращать индекс найденного элемента, или некоторое отрицательное число,если оно не нашлось
