...
public class Currency {
    public static void main(String[] args) {
        ...
        System.out.println("Which currency do you have? (USD,CHF,GBR)");
        ...
        switch (currency) {
            ...
            case "CHF" -> result = exchange(summa, rateUsd);
            case "GBP" -> result = exchange(summa, rateUsd);
...
/**Шаг 1.**
 ...
 метод-конвертор получает на вход double количество валюты, метод должен рассчитывать на количество евро,
 которое нам надо отдать за эту валюту.
 количество евро = количество валюты * курс =rate
 //**Шаг 3.**
 //Как это уже решали?
