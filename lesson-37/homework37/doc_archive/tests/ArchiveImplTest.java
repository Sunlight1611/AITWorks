package homework37.doc_archive.tests;

import homework37.doc_archive.model.Document;
import homework37.doc_archive.dao.Archive;
import homework37.doc_archive.dao.ArchiveImpl;
...
//        ph[5] = new Photo(1, 4, "title4", "url1", LocalDateTime.of(now.minusDays(2).toLocalDate(), LocalTime.MAX));
        ...
        d[0] = new Document(1,1,"101","url1",now.minusDays(2));
        d[1] = new Document(1,2,"102","url2",now.minusDays(3));
        d[2] = new Document(1,3,"103","url3",now.minusDays(5));
        d[3] = new Document(2,4,"104","url4",LocalDateTime.of(now.minusDays(7).toLocalDate(), LocalTime.MIN));
        d[4] = new Document(2,5,"105","url5",LocalDateTime.of(now.minusDays(7).toLocalDate(), LocalTime.MIN));
        d[5] = new Document(1,6,"106","url6",LocalDateTime.of(now.minusDays(7).toLocalDate(), LocalTime.MIN));
...
//        }
    ...
    void addDocumentTest() {
        ...
        Document doc = new Document(3,1,"107","url",now);
