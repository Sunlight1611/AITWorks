...
class CityTest {
    ...
    cities = new City[6];
    cities[0] = new City("Denver", 600_000,"USA",7.0);
    cities[1] = new City("Boston", 670_000,"USA",7.5);
    ...
    void testComparable(){
        ...
        City city = new City(null,1200000,null,0);
    ...
    void testCopyOfRange(){
        ...
        City[] citiesCopyRange = Arrays.copyOfRange(cities,1,cities.length);
        printArray(citiesCopyRange,"Cities Copy of Rang from 1 to last");
    }
    //- создать копию массива, увеличить его длину, вставить содержимое внутрь
    @Test
    ...
    void testArrayCopy(){
        ...
        System.out.println("---------------------------");
        City newCity = new City("Yalta",0,null,5);
    ...
    void testKeepSorted(){
        ...
        City[] citiesCopy = Arrays.copyOf(cities,cities.length + 1);// создаём копию массива с длиной на 1 больше
