...
public class Methods1 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Cub = " + cub0fNumber(a));
    ...
    public static double cub0fNumber(double z){
        return z * z * z;
    }
    public static int absolute(int number){ //Это сигнатура метода ( 1-ая строчка каждого метода)
        return - number;
